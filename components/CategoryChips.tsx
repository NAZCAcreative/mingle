        ...
        {visibleCategories.map((category) => {
          ...
          return (
            <button
              ...
              className={`flex h-[96px] min-w-[96px] snap-start flex-col items-center justify-center gap-2 rounded-[18px] border text-[16px] font-black shadow-card transition ${
